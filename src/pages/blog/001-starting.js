          ...
          <article className="blog-intro">
            ...
            <div className="text-[var(--color-total)] max-w-full w-full mb-16 px-[5%] leading-[50px] text-[26px]">
              <section className="intro-text">
                ...
                <br />
                <p>
                  At 17, my definition of success was simple: <strong>Independence</strong>. I wanted to be my own boss. Like many of my peers, I looked at the markets. Trading seemed like the fast track to wealth. I spent hours thinking about charts and financial freedom.
                </p>
                <br />
                <p>
                  Coding hadn't always been what I had in mind. My brother was the first to plant the seed of programming. At first, I didn't get it. To me, it was just bah...I don't know lemme check on google.
                  so programming is the process of designing, writing, testing, and maintaining code that computers can execute. Still don't get it. anyway I'll figure it out later.
                </p>
                <br />
                <h4 className="text-[32px] font-bold mb-4 mt-8">The Realization</h4>
                <p>
                  It took a rejection from Medical School to clear the fog. That "No" from the university was the "Yes" I needed for my career. I looked at programming again, but this time through a different lens. I realized code wasn't not just a way of telling the computer what to do but the bridge between all my interests:
                </p>
                <br />
